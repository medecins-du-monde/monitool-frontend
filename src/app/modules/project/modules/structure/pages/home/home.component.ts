            ...
            this.dataSource = [
              {
                ...
                routerLink1: `/projects/${savedProject.id}/structure/basics`,
                routerLink2: '',
              },
              {
                taskText1: new MultiLanguage({
                ...
                buttonIcon2: '',
                buttonText2: new MultiLanguage(),
                routerLink1: `/projects/${savedProject.id}/structure/sites`,
                routerLink2: '',
              },
              {
                taskText1: new MultiLanguage({
                ...
                buttonIcon2: '',
                buttonText2: new MultiLanguage(),
                routerLink1: `/projects/${savedProject.id}/structure/logical-frames`,
                routerLink2: '',
              },
              {
                taskText1: new MultiLanguage({
              ...
              },
              {
                ...
                buttonIcon2: '',
                buttonText2: new MultiLanguage(),
                routerLink1: `/projects/${savedProject.id}/structure/extra-indicators`,
                routerLink2: '',
              },
              {
                taskText1: new MultiLanguage({
                ...
                routerLink1: `/projects/${savedProject.id}/structure/data-sources`,
                routerLink2: `/projects/${savedProject.id}/structure/logical-frames`,
              },
              {
                taskText1: new MultiLanguage({
                ...
                buttonIcon2: '',
                buttonText2: new MultiLanguage(),
                routerLink1: `/projects/${savedProject.id}/structure/cross-cutting`,
                routerLink2: '',
              },
              {
                taskText1: new MultiLanguage({
